...
const MARQUEE_ITEMS = [
  `${brand.appName} in 15 minutes`, "Completely anonymous", "No stored messages",
  "Real humans only", "No advice, just presence", "Disappears in 7 days",
];

const FEATURES = [
  { num: "01", title: `${brand.appName} yourself`, desc: "Say what's weighing on you without names, judgment, or consequences." },
      ...
      <div className="dark-canvas" style={{ minHeight: "100vh", overflow: "visible" }}>
        ...
        <section className="hero-content" style={{
          ...
          <div className="hero-actions" style={{ display: "flex", gap: 14, alignItems: "center", flexWrap: "wrap" }}>
            ...
            >
              {authed ? `Let's ${brand.appNamePlain}` : "Get started"}
            </Link>
          </div>
        </section>
