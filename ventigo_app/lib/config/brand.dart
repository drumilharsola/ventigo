...
///   flutter build apk --flavor ventigo --dart-define=BRAND=ventigo
...
/// Active brand flavor name (e.g. "ventigo", "clientdemo").
const String _brandFlavor = String.fromEnvironment(
  'BRAND',
  defaultValue: 'ventigo',
);
...
class Brand {
  ...
  static const String tagline = String.fromEnvironment(
    'BRAND_TAGLINE',
    defaultValue: 'vent \u00b7 listen \u00b7 breathe',
  );
  ...
  static const logo = BrandLogo(
    ...
    prefix: String.fromEnvironment('BRAND_LOGO_PREFIX', defaultValue: 'ven'),
    emphasis: String.fromEnvironment('BRAND_LOGO_EMPHASIS', defaultValue: 'tigo'),
